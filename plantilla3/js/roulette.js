...
var data = [
    ...
    { id: '', type: 'quiz', color: '#E5177B', text:' ', ikon: 'icon-personaje' },
    { id: '', type: 'quiz', color: '#BE107F', text:' ', ikon: 'icon-personaje' },
    { id: '', type: 'quiz', color: '#E5177B', text:' ', ikon: 'icon-personaje' },
    { id: '', type: 'quiz', color: '#BE107F', text:' ', ikon: 'icon-personaje' },
...
RouletteWheel.prototype.render = function(){
    ...
    for(var i=0; i<count; i++){
        ...
        if(ikon)
            ...
            html.push('<i class=" '+ikon+'" style="vertical-align: inherit;"></i>');
